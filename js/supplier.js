function listSuppliers() {
    ...
    e.DataTable({
        ajax: {
            url: "includes/data_operation.php?action=listSupplier",
            dataSrc: ""
        },
        columns: [{
            data: "id"
    ...
    $("div.head-label").html('<h3 class="mb-0">List of Suppliers</h3>')
}
...
function editprod(id) {
    ...
    $("#action").val("editSupplier");
    $("#supplierAdd").append('<input type="hidden" value="' + id + '" name="editid" />');
    $("input[name='name']").val(name);
    $("input[name='phone']").val(phone);
    $("input[name='address']").val(address);
    $("input[name='submit']").val("Edit Supplier");
    ...
    $("#delform").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#listSuppliers").DataTable().ajax.reload(null, false);
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (action == "editSupplier") {
                    ...
                    $("#action").val("addSupplier");
                    $("input[name='submit']").val("Add Supplier");
                } else {

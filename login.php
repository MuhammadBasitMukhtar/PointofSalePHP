    ...
    <div class="card mb-0">
      <div class="card-body">
        <a href="index.html" class="brand-logo">
          ...
          <h2 class="brand-text text-primary ms-1">POS</h2>
        </a>

        <h4 class="card-title mb-1">Assalamu Alaikum! 👋</h4>
        <p class="card-text mb-2">Sign in to continue!</p>

        <form class="auth-login-form mt-2" action="includes/data_operation.php" method="POST">
          <div class="mb-1">
            <label for="login-email" class="form-label">Username</label>
            <input type="hidden" name="action" value="authSign"/>
            <input
              type="text"
              class="form-control"
              id="login-email"
